 ...
 */
public class JogWatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                imageView1.setBackgroundResource(R.drawable.jogclock);
                imageView2.setBackgroundResource(R.drawable.jogclock);
                ...
                imageView11.setBackgroundResource(R.drawable.jogclock);
                imageView12.setBackgroundResource(R.drawable.jogclock);
                imageView13.setBackgroundResource(R.drawable.jogclock);
                imageView14.setBackgroundResource(R.drawable.jogclock);
                imageView15.setBackgroundResource(R.drawable.jogclock);
                imageView16.setBackgroundResource(R.drawable.jogclock);
                imageView17.setBackgroundResource(R.drawable.jogclock);
                imageView18.setBackgroundResource(R.drawable.jogclock);
                imageView19.setBackgroundResource(R.drawable.jogclock);
                imageView20.setBackgroundResource(R.drawable.jogclock);

                ivLeftNumber.setBackgroundResource(R.drawable.circleseven);
            ...
            case 2:
                imageView1.setBackgroundResource(R.drawable.jogclock);
                imageView2.setBackgroundResource(R.drawable.jogclock);
                imageView3.setBackgroundResource(R.drawable.jogclock);
                imageView4.setBackgroundResource(R.drawable.blank);
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogclock);
                imageView8.setBackgroundResource(R.drawable.jogclock);
                imageView9.setBackgroundResource(R.drawable.jogclock);
                imageView10.setBackgroundResource(R.drawable.jogclock);
                imageView11.setBackgroundResource(R.drawable.jogclock);
                imageView12.setBackgroundResource(R.drawable.jogclock);
                imageView13.setBackgroundResource(R.drawable.jogclock);
                imageView14.setBackgroundResource(R.drawable.jogclock);
                ...
                ibLeft.setBackgroundResource(R.drawable.sotaro);
                ibCenter.setBackgroundResource(R.drawable.unis);
                ibRight.setBackgroundResource(R.drawable.atharo);
                break;
            ...
            case 3:
                ...
                ivRightNumber.setBackgroundResource(R.drawable.circlethree);

                ivsign.setBackgroundResource(R.drawable.circleplas);
                ivEqual.setBackgroundResource(R.drawable.circleequal);

                ibLeft.setBackgroundResource(R.drawable.att);
                ibCenter.setBackgroundResource(R.drawable.noi);
                ibRight.setBackgroundResource(R.drawable.satt);
                break;
            ...
            case 4:
                ...
                ivRightNumber.setBackgroundResource(R.drawable.circlesix);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogWatch.class);
