 ...
 */
public class JogFootbal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                ...
                imageView11.setBackgroundResource(R.drawable.jogfootball);
                imageView12.setBackgroundResource(R.drawable.jogfootball);
                imageView13.setBackgroundResource(R.drawable.jogfootball);
                imageView14.setBackgroundResource(R.drawable.jogfootball);
                imageView15.setBackgroundResource(R.drawable.blank);

                imageView16.setBackgroundResource(R.drawable.blank);
                imageView17.setBackgroundResource(R.drawable.jogfootball);
                imageView18.setBackgroundResource(R.drawable.jogfootball);
                imageView19.setBackgroundResource(R.drawable.jogfootball);
                ...
                ibCenter.setBackgroundResource(R.drawable.satt);
                ibRight.setBackgroundResource(R.drawable.noi);

                break;

            case 2:
                imageView1.setBackgroundResource(R.drawable.blank);
                imageView2.setBackgroundResource(R.drawable.jogfootball);
                imageView3.setBackgroundResource(R.drawable.jogfootball);
                imageView4.setBackgroundResource(R.drawable.jogfootball);
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogfootball);
                imageView8.setBackgroundResource(R.drawable.blank);
                imageView9.setBackgroundResource(R.drawable.jogfootball);
                imageView10.setBackgroundResource(R.drawable.blank);
                ...
                imageView14.setBackgroundResource(R.drawable.jogfootball);
                imageView15.setBackgroundResource(R.drawable.blank);
                imageView16.setBackgroundResource(R.drawable.jogfootball);
                imageView17.setBackgroundResource(R.drawable.jogfootball);
                imageView18.setBackgroundResource(R.drawable.jogfootball);
                imageView19.setBackgroundResource(R.drawable.jogfootball);
                imageView20.setBackgroundResource(R.drawable.jogfootball);
            ...
            case 3:
                ...
                imageView13.setBackgroundResource(R.drawable.jogfootball);
                imageView14.setBackgroundResource(R.drawable.jogfootball);
                imageView15.setBackgroundResource(R.drawable.jogfootball);
                imageView16.setBackgroundResource(R.drawable.jogfootball);
                imageView17.setBackgroundResource(R.drawable.jogfootball);
                imageView18.setBackgroundResource(R.drawable.jogfootball);
                imageView19.setBackgroundResource(R.drawable.jogfootball);
            ...
            case 4:
                ...
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogfootball);
                imageView8.setBackgroundResource(R.drawable.jogfootball);
                imageView9.setBackgroundResource(R.drawable.jogfootball);
                imageView10.setBackgroundResource(R.drawable.jogfootball);
                imageView11.setBackgroundResource(R.drawable.jogfootball);
                imageView12.setBackgroundResource(R.drawable.jogfootball);
                imageView13.setBackgroundResource(R.drawable.jogfootball);
                imageView14.setBackgroundResource(R.drawable.jogfootball);
                ...
                ibLeft.setBackgroundResource(R.drawable.coddo);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogFootbal.class);
