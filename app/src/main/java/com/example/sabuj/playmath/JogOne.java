 ...
 */
public class JogOne extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jog_one);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ib_left:
               ...
               Intent intentLeft = new Intent(this,JogTwo.class);
                startActivity(intentLeft);
                break;

            case R.id.ib_center:
                Toast.makeText(getApplicationContext(),"Right Answer",Toast.LENGTH_SHORT).show();
                Intent intentCenter = new Intent(this,JogTwo.class);
            ...
            case R.id.ib_right:
                ...
                Toast.makeText(getApplicationContext(),"Wrong Answer",Toast.LENGTH_SHORT).show();
                Intent intentRight = new Intent(this,JogTwo.class);
