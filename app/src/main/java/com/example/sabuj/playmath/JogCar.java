 ...
 */
public class JogCar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                imageView1.setBackgroundResource(R.drawable.jogcar);
                imageView2.setBackgroundResource(R.drawable.jogcar);
                ...
                imageView11.setBackgroundResource(R.drawable.jogcar);
                imageView12.setBackgroundResource(R.drawable.jogcar);
                imageView13.setBackgroundResource(R.drawable.jogcar);
                imageView14.setBackgroundResource(R.drawable.jogcar);
                imageView15.setBackgroundResource(R.drawable.jogcar);
                imageView16.setBackgroundResource(R.drawable.jogcar);
                imageView17.setBackgroundResource(R.drawable.jogcar);
                imageView18.setBackgroundResource(R.drawable.jogcar);
                imageView19.setBackgroundResource(R.drawable.jogcar);
                imageView20.setBackgroundResource(R.drawable.jogcar);
            ...
            case 2:
                imageView1.setBackgroundResource(R.drawable.jogcar);
                imageView2.setBackgroundResource(R.drawable.jogcar);
                imageView3.setBackgroundResource(R.drawable.jogcar);
                imageView4.setBackgroundResource(R.drawable.blank);
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogcar);
                imageView8.setBackgroundResource(R.drawable.jogcar);
                imageView9.setBackgroundResource(R.drawable.jogcar);
                imageView10.setBackgroundResource(R.drawable.jogcar);
                imageView11.setBackgroundResource(R.drawable.jogcar);
                imageView12.setBackgroundResource(R.drawable.jogcar);
                imageView13.setBackgroundResource(R.drawable.jogcar);
                imageView14.setBackgroundResource(R.drawable.jogcar);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogCar.class);
