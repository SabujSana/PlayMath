 ...
 */
public class JogCat extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                ...
                imageView7.setBackgroundResource(R.drawable.jogcat);
                imageView8.setBackgroundResource(R.drawable.jogcat);
                imageView9.setBackgroundResource(R.drawable.jogcat);
                imageView10.setBackgroundResource(R.drawable.jogcat);
                imageView11.setBackgroundResource(R.drawable.jogcat);
                imageView12.setBackgroundResource(R.drawable.jogcat);
                imageView13.setBackgroundResource(R.drawable.jogcat);
                imageView14.setBackgroundResource(R.drawable.jogcat);
                imageView15.setBackgroundResource(R.drawable.jogcat);

                imageView16.setBackgroundResource(R.drawable.jogcat);
                imageView17.setBackgroundResource(R.drawable.jogcat);
                imageView18.setBackgroundResource(R.drawable.jogcat);
                imageView19.setBackgroundResource(R.drawable.jogcat);
                imageView20.setBackgroundResource(R.drawable.jogcat);
            ...
            case 3:
                ...
                imageView1.setBackgroundResource(R.drawable.jogcat);
                imageView2.setBackgroundResource(R.drawable.jogcat);
                imageView3.setBackgroundResource(R.drawable.jogcat);
                imageView4.setBackgroundResource(R.drawable.jogcat);
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.blank);
                imageView8.setBackgroundResource(R.drawable.jogcat);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogCat.class);
