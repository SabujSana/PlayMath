 ...
 */
public class TulonakhaliVorti extends AppCompatActivity {
    ImageButton buttonLeft, buttonRight;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tulona_khali_vorti);
    ...
    public void Left(View view) {
        ...
        Intent intent = new Intent(TulonakhaliVorti.this, TulonaHalkaVari.class);
    ...
    public void right() {
        ...
        Toast toast = new Toast(TulonakhaliVorti.this);
