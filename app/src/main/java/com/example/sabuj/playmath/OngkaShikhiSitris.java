 ...
 */
public class OngkaShikhiSitris extends AppCompatActivity implements View.OnClickListener{
ImageButton leftBtn,cntrBtn,rghtBtn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ongka_shikhi_sitris);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ib_left:
                ...
                Intent intentLeft = new Intent(this,OngkaShikhiThirtyThree.class);
            ...
            case R.id.ib_center:
                ...
                Toast.makeText(getApplicationContext(),"Wrong Answer",Toast.LENGTH_SHORT).show();
                Intent intentCenter = new Intent(this,OngkaShikhiThirtyThree.class);
                startActivity(intentCenter);
                break;

            case R.id.ib_right:
                Toast.makeText(getApplicationContext(),"Right Answer",Toast.LENGTH_SHORT).show();
                Intent intentRight = new Intent(this,OngkaShikhiThirtyThree.class);
