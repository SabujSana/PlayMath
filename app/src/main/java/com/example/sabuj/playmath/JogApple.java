 ...
 */
public class JogApple extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                ...
                imageView11.setBackgroundResource(R.drawable.jogapple);
                imageView12.setBackgroundResource(R.drawable.jogapple);
                imageView13.setBackgroundResource(R.drawable.jogapple);
                imageView14.setBackgroundResource(R.drawable.jogapple);
                imageView15.setBackgroundResource(R.drawable.blank);

                imageView16.setBackgroundResource(R.drawable.blank);
                imageView17.setBackgroundResource(R.drawable.jogapple);
                imageView18.setBackgroundResource(R.drawable.jogapple);
                imageView19.setBackgroundResource(R.drawable.jogapple);
            ...
            case 2:
                imageView1.setBackgroundResource(R.drawable.blank);
                imageView2.setBackgroundResource(R.drawable.jogapple);
                imageView3.setBackgroundResource(R.drawable.jogapple);
                imageView4.setBackgroundResource(R.drawable.jogapple);
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogapple);
                imageView8.setBackgroundResource(R.drawable.blank);
                imageView9.setBackgroundResource(R.drawable.jogapple);
                imageView10.setBackgroundResource(R.drawable.blank);
                ...
                imageView14.setBackgroundResource(R.drawable.jogapple);
                imageView15.setBackgroundResource(R.drawable.blank);
                imageView16.setBackgroundResource(R.drawable.jogapple);
                imageView17.setBackgroundResource(R.drawable.jogapple);
                imageView18.setBackgroundResource(R.drawable.jogapple);
                imageView19.setBackgroundResource(R.drawable.jogapple);
                imageView20.setBackgroundResource(R.drawable.jogapple);
            ...
            case 3:
                ...
                imageView13.setBackgroundResource(R.drawable.jogapple);
                imageView14.setBackgroundResource(R.drawable.jogapple);
                imageView15.setBackgroundResource(R.drawable.jogapple);
                imageView16.setBackgroundResource(R.drawable.jogapple);
                imageView17.setBackgroundResource(R.drawable.jogapple);
                imageView18.setBackgroundResource(R.drawable.jogapple);
                imageView19.setBackgroundResource(R.drawable.jogapple);
            ...
            case 4:
                ...
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogapple);
                imageView8.setBackgroundResource(R.drawable.jogapple);
                imageView9.setBackgroundResource(R.drawable.jogapple);
                imageView10.setBackgroundResource(R.drawable.jogapple);
                imageView11.setBackgroundResource(R.drawable.jogapple);
                imageView12.setBackgroundResource(R.drawable.jogapple);
                imageView13.setBackgroundResource(R.drawable.jogapple);
                imageView14.setBackgroundResource(R.drawable.jogapple);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogApple.class);
