 ...
 */
public class JogGlass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                imageView1.setBackgroundResource(R.drawable.jogglass);
                imageView2.setBackgroundResource(R.drawable.jogglass);
                imageView3.setBackgroundResource(R.drawable.jogglass);
                imageView4.setBackgroundResource(R.drawable.jogglass);
                ...
                imageView8.setBackgroundResource(R.drawable.jogglass);
                imageView9.setBackgroundResource(R.drawable.jogglass);
                imageView10.setBackgroundResource(R.drawable.blank);
                imageView11.setBackgroundResource(R.drawable.jogglass);
                imageView12.setBackgroundResource(R.drawable.jogglass);
                imageView13.setBackgroundResource(R.drawable.jogglass);
                imageView14.setBackgroundResource(R.drawable.jogglass);
                ...
                imageView18.setBackgroundResource(R.drawable.jogglass);
                imageView19.setBackgroundResource(R.drawable.jogglass);
                imageView20.setBackgroundResource(R.drawable.blank);

                ivLeftNumber.setBackgroundResource(R.drawable.circleeight);
                ivRightNumber.setBackgroundResource(R.drawable.circlefour);

                ivsign.setBackgroundResource(R.drawable.circleplas);
                ivEqual.setBackgroundResource(R.drawable.circleequal);

                ibLeft.setBackgroundResource(R.drawable.agaro);
                ibCenter.setBackgroundResource(R.drawable.taro);
                ibRight.setBackgroundResource(R.drawable.baro);
            ...
            case 2:
                ...
                imageView8.setBackgroundResource(R.drawable.jogglass);
                imageView9.setBackgroundResource(R.drawable.jogglass);
                imageView10.setBackgroundResource(R.drawable.jogglass);
                imageView11.setBackgroundResource(R.drawable.jogglass);
                imageView12.setBackgroundResource(R.drawable.jogglass);
                imageView13.setBackgroundResource(R.drawable.jogglass);
                imageView14.setBackgroundResource(R.drawable.jogglass);
                imageView15.setBackgroundResource(R.drawable.jogglass);
                imageView16.setBackgroundResource(R.drawable.blank);
                imageView17.setBackgroundResource(R.drawable.jogglass);
                imageView18.setBackgroundResource(R.drawable.jogglass);
                imageView19.setBackgroundResource(R.drawable.jogglass);
                imageView20.setBackgroundResource(R.drawable.jogglass);

                ivLeftNumber.setBackgroundResource(R.drawable.circlefive);
                ivRightNumber.setBackgroundResource(R.drawable.circleseven);

                ivsign.setBackgroundResource(R.drawable.circleplas);
                ivEqual.setBackgroundResource(R.drawable.circleequal);

                ibLeft.setBackgroundResource(R.drawable.baro);
                ibCenter.setBackgroundResource(R.drawable.agaro);
            ...
            case 3:
                ...
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogglass);
                imageView8.setBackgroundResource(R.drawable.jogglass);
                imageView9.setBackgroundResource(R.drawable.jogglass);
                imageView10.setBackgroundResource(R.drawable.jogglass);
                imageView11.setBackgroundResource(R.drawable.jogglass);
                ...
                imageView14.setBackgroundResource(R.drawable.jogglass);
                imageView15.setBackgroundResource(R.drawable.blank);
                imageView16.setBackgroundResource(R.drawable.jogglass);
                imageView17.setBackgroundResource(R.drawable.jogglass);
                imageView18.setBackgroundResource(R.drawable.jogglass);
                imageView19.setBackgroundResource(R.drawable.jogglass);
                imageView20.setBackgroundResource(R.drawable.jogglass);
                ...
                ibCenter.setBackgroundResource(R.drawable.ponero);
                ibRight.setBackgroundResource(R.drawable.coddo);
                break;
            ...
            case 5:
                ...
                ibLeft.setBackgroundResource(R.drawable.unis);
                ibCenter.setBackgroundResource(R.drawable.atharo);
                ibRight.setBackgroundResource(R.drawable.sotaro);
                break;
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogGlass.class);
