 ...
 */
public class JogCone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (value) {
            case 1:
                imageView1.setBackgroundResource(R.drawable.jogcone);
                imageView2.setBackgroundResource(R.drawable.jogcone);
                imageView3.setBackgroundResource(R.drawable.jogcone);
                imageView4.setBackgroundResource(R.drawable.jogcone);
                ...
                imageView8.setBackgroundResource(R.drawable.jogcone);
                imageView9.setBackgroundResource(R.drawable.jogcone);
                imageView10.setBackgroundResource(R.drawable.blank);
                imageView11.setBackgroundResource(R.drawable.jogcone);
                imageView12.setBackgroundResource(R.drawable.jogcone);
                imageView13.setBackgroundResource(R.drawable.jogcone);
                imageView14.setBackgroundResource(R.drawable.jogcone);
                ...
                imageView18.setBackgroundResource(R.drawable.jogcone);
                imageView19.setBackgroundResource(R.drawable.jogcone);
            ...
            case 2:
                ...
                imageView8.setBackgroundResource(R.drawable.jogcone);
                imageView9.setBackgroundResource(R.drawable.jogcone);
                imageView10.setBackgroundResource(R.drawable.jogcone);
                imageView11.setBackgroundResource(R.drawable.jogcone);
                imageView12.setBackgroundResource(R.drawable.jogcone);
                imageView13.setBackgroundResource(R.drawable.jogcone);
                imageView14.setBackgroundResource(R.drawable.jogcone);
                imageView15.setBackgroundResource(R.drawable.jogcone);
                imageView16.setBackgroundResource(R.drawable.blank);
                imageView17.setBackgroundResource(R.drawable.jogcone);
                imageView18.setBackgroundResource(R.drawable.jogcone);
                imageView19.setBackgroundResource(R.drawable.jogcone);
                imageView20.setBackgroundResource(R.drawable.jogcone);
            ...
            case 3:
                ...
                imageView5.setBackgroundResource(R.drawable.blank);
                imageView6.setBackgroundResource(R.drawable.blank);
                imageView7.setBackgroundResource(R.drawable.jogcone);
                imageView8.setBackgroundResource(R.drawable.jogcone);
                imageView9.setBackgroundResource(R.drawable.jogcone);
                imageView10.setBackgroundResource(R.drawable.jogcone);
                imageView11.setBackgroundResource(R.drawable.jogcone);
                ...
                imageView14.setBackgroundResource(R.drawable.jogcone);
                imageView15.setBackgroundResource(R.drawable.blank);
                imageView16.setBackgroundResource(R.drawable.jogcone);
                imageView17.setBackgroundResource(R.drawable.jogcone);
                imageView18.setBackgroundResource(R.drawable.jogcone);
                imageView19.setBackgroundResource(R.drawable.jogcone);
                imageView20.setBackgroundResource(R.drawable.jogcone);
    ...
    public void Left(View view) {
        ...
        if (value != 5) {
            ...
            Intent intent = new Intent(getBaseContext(), JogCone.class);
