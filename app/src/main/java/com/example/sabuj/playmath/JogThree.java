 ...
 */
public class JogThree extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jog_three);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ib_left:
               ...
               Intent intentLeft = new Intent(this,JogFour.class);
               startActivity(intentLeft);
                break;

            case R.id.ib_center:
                Toast.makeText(getApplicationContext(),"Wrong Answer",Toast.LENGTH_SHORT).show();
                Intent intentCenter = new Intent(this,JogFour.class);
            ...
            case R.id.ib_right:
                ...
                Intent intentRight = new Intent(this,JogFour.class);
