 ...
 */
public class JogTwo extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jog_two);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ib_left:
               ...
               Intent intentLeft = new Intent(this,JogThree.class);
               startActivity(intentLeft);
                break;

            case R.id.ib_center:
                Toast.makeText(getApplicationContext(),"Wrong Answer",Toast.LENGTH_SHORT).show();
                Intent intentCenter = new Intent(this,JogThree.class);
            ...
            case R.id.ib_right:
                ...
                Toast.makeText(getApplicationContext(),"Wrong Answer",Toast.LENGTH_SHORT).show();
                Intent intentRight = new Intent(this,JogThree.class);
