 ...
 */
public class GononaCity extends AppCompatActivity implements View.OnClickListener{
...
switch (view.getId()){
    ...
    case R.id.oneLeft:
        Intent intentOne = new Intent(this,GononaCityView.class);
    ...
    case R.id.oneCenter:
        Intent intentTwo = new Intent(this,GononaCityView.class);
    ...
    case R.id.oneRight:
        Intent intentThree = new Intent(this,GononaCityView.class);
    ...
    case R.id.twoLeft:
        Intent intentFour= new Intent(this,GononaCityView.class);
    ...
    case R.id.twoCenter:
        Intent intentFive = new Intent(this,GononaCityView.class);
    ...
    case R.id.twoRight:
        Intent intentSix = new Intent(this,GononaCityView.class);
    ...
    case R.id.threeLeft:
        Intent intentSeven= new Intent(this,GononaCityView.class);
    ...
    case R.id.threeCenter:
        Intent intentEight = new Intent(this,GononaCityView.class);
    ...
    case R.id.threeRight:
        Intent intentNine = new Intent(this,GononaCityView.class);
    ...
    case R.id.fourCenter:
        Intent intentTen = new Intent(this,GononaCityView.class);
