 ...
 */
public class TulonaHalkaVari extends AppCompatActivity {
    ImageButton buttonLeft, buttonRight;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tulona_halka_vari);
    ...
    public void Left(View view) {
        ...
        Intent intent = new Intent(TulonaHalkaVari.this, TulonaLombaKhato.class);
    ...
    public void right() {
        ...
        Toast toast = new Toast(TulonaHalkaVari.this);
