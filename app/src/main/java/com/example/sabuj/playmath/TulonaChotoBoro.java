 ...
 */
public class TulonaChotoBoro extends AppCompatActivity {
    ImageButton buttonLeft, buttonRight;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tulona_choto_boro);
    ...
    public void Left(View view) {
        ...
        Intent intent = new Intent(TulonaChotoBoro.this, TulonakhaliVorti.class);
    ...
    public void right() {
        ...
        Toast toast = new Toast(TulonaChotoBoro.this);
